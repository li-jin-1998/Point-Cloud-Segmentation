...
def main():
    ...
    parser.add_argument('--folder', '-f', default='/mnt/algo_storage_server/PointCloudSeg/shapenet',
                        help='Path to data folder.')
    parser.add_argument('--dataset', '-d', default='shapenet_partseg', help='Dataset to download.')
